...
$(document).ready(function() {
  ...
  var question = [
    ...
    "What was Voldemort's mother's maiden name?",
    "How many points is the Golden Snitch worth?",
    "What is the only antidote to Basilisk's venom?",
  ...
  function displayImage() {
    if (count === 0) {
      $("#image-holder").show();
      $("#image-holder").html(
        '<img src="assets/images/tom_marvolo_riddle.jpg">'
      );
    } else if (count === 1) {
      $("#image-holder").show();
      ...
      $("#image-holder").show();
      $("#image-holder").html(
        '<img src="assets/images/neville_longbottom.jpg">'
      );
    }
  }
